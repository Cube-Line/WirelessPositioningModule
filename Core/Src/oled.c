...
void OLED_WR_Byte(uint8_t data, uint8_t cmd)
{
	...
	// if (0x00 == cmd)
	{
		// HAL_I2C_Mem_Write(&hi2c1, (uint16_t)OLED_ADDRESS, OLED_CMD, 8, (uint8_t *)&data, sizeof(data), 1000);
		// HAL_Delay(1);
		HAL_I2C_Master_Transmit(&hi2c1, (uint16_t)OLED_ADDRESS, (uint8_t *)&Data, 2, 1000);
	}
}
